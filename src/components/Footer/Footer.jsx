...
const Footer = () => {
  return (
    ...
    <footer>
      <div className='grid justify-center lg:absolute top-805 left-135'>
  ...
  <div className="text-white footer sm:footer-horizontal bg-[#06091A] text-base-content pt-65 pb-8 grid justify-around items-center">
